...
class DatabaseLoader {
	...
	CommandLineRunner init(StudentRepository repository) {
		...
		return args -> {
			repository.save(new Student("Frodo", "Female", "Paris","1999-03-11","ComputerScience","171860030"));
			repository.save(new Student("Bilbo", "Male", "London","1999-04-26","PE","171860031"));
		};
	}
